...
export function TeamDetailPage() {
    ...
    const handleRemoveMember = async (memberId: string) => {
        if (currentTeam?.id && window.confirm('Biztosan eltávolítod ezt a tagot?')) {
            ...
            <div className="tab-content">
                    ...
                    <div className="overview-tab">
                        ...
                        <div className="stats-grid">
                            ...
                            <div className="stat-card card">
                                ...
                                <div className="stat-info">
                                    <span className="stat-value">{currentTeam.members?.length || 0}</span>
                ...
                {activeTab === 'tournaments' && (
                    <div className="tournaments-tab">
                        ...
                        {currentTeam.tournamentEntries && currentTeam.tournamentEntries.length > 0 ? (
