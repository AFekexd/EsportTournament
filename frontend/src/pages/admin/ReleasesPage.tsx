...
export default function ReleasesPage() {
  ...
  return (
    <div className="container mx-auto p-6 max-w-7xl animate-fade-in">
      <h1 className="text-3xl font-bold text-foreground mb-2">Kiadások Kezelése</h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-1 space-y-6">
          <div className="bg-[#121A22] border border-border rounded-2xl p-6 sticky top-6">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <input
                  ...
                  className="w-full bg-secondary border border-border rounded-lg px-4 py-2 text-foreground focus:outline-none focus:border-primary/50 transition-colors"
                />
              </div>
            ...
            {loading ? (
              ...
              <div className="space-y-6">
                {history.map((release) => (
                  <div
                    key={release.id}
                    className="relative pl-6 border-l-2 border-border pb-2 last:pb-0"
                  >
                    <div className="absolute -left-[9px] top-0 w-4 h-4 rounded-full bg-[#121A22] border-2 border-primary" />

                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-3 bg-secondary p-4 rounded-xl border border-border">
                      <div>
