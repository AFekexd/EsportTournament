    ...
    <div className="fixed inset-0 overflow-hidden bg-[#121A22] font-sans selection:bg-purple-500/30">
      ...
      <div className="relative z-10 flex h-full flex-col items-center justify-center p-12 text-center animate-in fade-in zoom-in duration-1000">
        ...
        <div className="mb-6 flex h-40 w-40 items-center justify-center rounded-xl p-2 bg-gradient-to-br from-purple-500 to-pink-600 shadow-[0_0_80px_rgba(168,85,247,0.4)] animate-bounce-slow">
          <Megaphone className="h-20 w-20 text-foreground" />
        </div>

        {/* Main Title */}
        <h1 className="mb-6 text-8xl font-black uppercase tracking-tight text-foreground drop-shadow-xl">
        ...
        {/* Contact Info Footer */}
        <div className="rounded-3xl bg-secondary border border-border p-10 backdrop-blur-md max-w-4xl w-full">
          <h3 className="text-3xl font-bold text-foreground mb-4 uppercase tracking-widest">
            Jelentkezés és Információ
          </h3>
          <div className="flex flex-col gap-2 text-2xl text-gray-300">
            <p>
              Keressétek a{" "}
              <span className="text-foreground font-black bg-primary/20 px-3 py-1 rounded">
                DÖK-ös
              </span>{" "}
              diáktársaitokat
            </p>
            ...
            <p>
              ...
              tanár urat{" "}
              <span className="text-foreground font-black  py-1 rounded">
                - Info VI.
              </span>
            </p>
          </div>
...
function RoleCard({
  ...
  return (
    <div className="flex flex-col items-center bg-[#121A22]/50 p-8 rounded-3xl border border-border backdrop-blur-sm shadow-xl hover:bg-[#121A22] transition-all transform hover:scale-105 group">
      <Icon
        className={`h-16 w-16 mb-6 ${color} group-hover:drop-shadow-[0_0_15px_rgba(255,255,255,0.3)] transition-all`}
      />
      <h3 className="text-3xl font-bold text-foreground mb-2 uppercase">{title}</h3>
