            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {games.map((game: Game) => {
                ...
                return (
                  <div
                    key={game.id}
                    className="card p-4 flex items-center justify-between card-glow"
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <div className="text-xs text-muted">
                          {userRank?.rank
                            ? `Jelenlegi: ${userRank.rank.name} (${userRank.rank.value} P-ELO)`
                            : "Nincs rang kiválasztva"}
                        </div>
                      </div>
                    </div>
            ...
            <div className="teams-grid">
              {userTeams.map((team: Team) => (
                <Link
                  key={team.id}
                  to={`/teams/${team.id}`}
                  className="team-mini-card card card-glow"
                >
            ...
            <div className="tournaments-list">
              {userTournaments.map((tournament: Tournament) => (
                <Link
                  ...
                  className="tournament-mini-card card card-glow"
                >
