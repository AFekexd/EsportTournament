    ...
    return (
        ...
        >
            ...
            <div className="relative w-full aspect-video overflow-hidden">
                ...
                {/* Team Size Badge */}
                <div className="absolute top-3 right-3 bg-black/60 backdrop-blur-md px-3 py-1 rounded-full border border-white/10 shadow-lg">
                    <span className="text-xs font-bold text-white tracking-wider flex items-center gap-1">
                        <Users size={12} className="text-primary" />
                        {teamSizeLabels[game.teamSize]}
                    </span>
                </div>
            </div>
            ...
            <div className="relative p-5 flex flex-col flex-grow">
                ...
                <div className="grid grid-cols-2 gap-3 mb-5 border-t border-white/5 pt-4">
                    <div className="flex items-center gap-2 text-gray-400 group-hover:text-gray-300 transition-colors">
                        ...
                        <span className="text-xs font-medium">{game._count?.tournaments || 0} verseny</span>
                    </div>
                    <div className="flex items-center gap-2 text-gray-400 group-hover:text-gray-300 transition-colors">
                        <Users size={16} className="text-blue-400" />
                        <span className="text-xs font-medium">{game._count?.gameStats || 0} játékos</span>
                    </div>
                </div>
        ...
        <div className="container mx-auto px-4 py-8">
            <div className="mb-12 text-center relative">
                ...
                <p className="text-lg text-gray-400 max-w-2xl mx-auto">
                    Válassz a támogatott esport játékok közül, és jelentkezz a legújabb versenyekre!
                </p>
            </div>
            ...
            {isLoading ? (
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
                    {[...Array(6)].map((_, i) => (
                        <div key={i} className="bg-[#1a1b26] rounded-xl overflow-hidden border border-white/5 h-[400px] animate-pulse">
                ...
                <div className="flex flex-col items-center justify-center py-20 bg-[#1a1b26]/50 rounded-2xl border border-white/5">
                    ...
                    <h3 className="text-xl font-bold text-white mb-2">Nincs elérhető játék</h3>
                    <p className="text-gray-400">Hamarosan új játékokat adunk hozzá a rendszerhez.</p>
                </div>
            ) : (
