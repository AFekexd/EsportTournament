      ...
      >
        ...
        <div className="p-4 md:p-6 overflow-y-auto custom-scrollbar flex-1 min-h-0">
          <div className="prose prose-invert max-w-none">
            ...
            {rulesPdfUrl ? (
              ...
              <div
                className="prose prose-invert max-w-none text-gray-300 [&>h1]:text-xl [&>h2]:text-lg [&>h3]:text-base [&>ul]:list-disc [&>ol]:list-decimal [&>ul]:pl-5 [&>ol]:pl-5 break-words"
        ...
        <div className="shrink-0 p-4 md:p-6 border-t border-white/10 bg-[#0f1016]/50 backdrop-blur-sm">
          {!viewOnly ? (
            <>
              <div
                className="flex items-start md:items-center gap-3 mb-4 md:mb-6 cursor-pointer group"
                onClick={() => setAccepted(!accepted)}
              >
                <div
                  className={`
                            w-6 h-6 rounded border-2 flex items-center justify-center transition-all duration-200 shrink-0 mt-0.5 md:mt-0
                            ${accepted
