...
export function DiscordConnectModal({ isOpen, onClose }: DiscordConnectModalProps) {
            ...
            >
                ...
                <div className="p-8">
                    <div className="text-center mb-8">
                        ...
                        <h2 className="text-2xl font-bold text-white mb-2">Discord Közösség</h2>
                        <p className="text-gray-400">Csatlakozz a szerverünkhöz vagy kösd össze a fiókodat!</p>
                    </div>
                    ...
                    <div className="grid gap-4">
                        ...
                        >
                            ...
                            <div>
                                <h3 className="text-lg font-bold text-white group-hover:text-[#5865F2] transition-colors">Csatlakozás</h3>
                        ...
                        <button
                            onClick={() => {
                                ...
                                if (!clientId) {
                                    ...
                                    alert('A rendszergazda nem állította be a Discord Client ID-t.');
                                    return;
                                }
                        ...
                        >
                            ...
                            <div className="text-left">
                                <h3 className="text-lg font-bold text-white">Gyors összekötés (OAuth)</h3>
                                <p className="text-sm text-white/80">Kattints az automatikus összekapcsoláshoz</p>
                            </div>
                        </button>

                        <div className="relative border-t border-white/10 pt-4 mt-2">
                            <p className="text-center text-sm text-gray-500 mb-4">Vagy használd a manuális módszert:</p>
                            ...
                            >
                                ...
                                <div className="text-left">
                                    <h3 className="text-lg font-bold text-white group-hover:text-gray-300 transition-colors">Manuális összekötés</h3>
                            ...
                            {showInstructions && (
                                <div className="mt-4 p-4 rounded-xl bg-black/40 border border-white/10 animate-in slide-in-from-top-2">
                                    ...
                                    <ol className="space-y-3 text-sm text-gray-300 list-decimal list-inside marker:text-emerald-500">
                                        <li className="pl-2">
                                            <span className="text-gray-400">Csatlakozz a szerverünkhöz a fenti gombbal.</span>
                                        </li>
                                        <li className="pl-2">
                                            <span className="text-gray-400">Használd a parancsokat bármelyik csatornán.</span>
                                        </li>
                                        <li className="pl-2">
                                        ...
                                        <li className="pl-2">
                                            <span className="text-gray-400">Vagy ha csak fiókot szeretnél kötni:</span>
                                            <div className="mt-1.5 ml-4 p-2 rounded bg-black/60 font-mono text-emerald-400 text-xs border border-white/5 select-all cursor-text">
                                                /link
                                            </div>
                                        </li>
